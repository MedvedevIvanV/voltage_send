...
#define sx1262_dio1_pin GPIO_PIN_5
#define sx1262_dio1_port GPIOB
#define sx1262_dio2_pin GPIO_PIN_8
#define sx1262_dio2_port GPIOB
...
arm_status status;
float frequency_ns = 12.5e-9;           // Частота в секундах (12.5 нс)
...
void SendDataViaLoRa(const uint8_t* data, uint8_t length);
/* USER CODE END PFP */
